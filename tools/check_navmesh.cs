...
Gate.Check("routing checks pass", sketchPassed, "the sketch's 11 checks all passed");
...
return Gate.Report("NAVMESH PASS — bakes from collision, routes around geometry, agents walk it",
                   "NAVMESH FAIL");
